        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link" data-toggle="dropdown" href="#">
                    <img class="rounded-circle" src="/dist/img/user2-160x160.jpg" alt="admin profile pic" width="25">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                    ...
                    <div class="d-flex justify-content-between p-3">
                        <a class="btn btn-sm border border-3 btn-light" href="/admin/auth/setting">Setting</a>
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="/admin/setting_chat" class="nav-link">
                                    <i class="fa-solid fa-bars mr-2"></i>
